# Bosch_Test
I use ansible to deploy an app in docker container to cloud vm(alibaba cloud), you can access http://47.254.147.185:3000/ to see the "Todo" application.(This is a foreign server，if you are in China, you need a VPN to access it. This ip is valid until 2022-06-12 23:59)
